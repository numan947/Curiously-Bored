...
//TO FIND OUT WHAT IS THE MAXIMUM LENGTH WE CAN GET FOR THE TRAIN,
//IF WE START TAKING FROM ith TRAIN POSITION, WE NEED TO FIND THE NUMBER OF
//TRAINS THAT HAVE LOWER WEIGHT THAN CURRENT ONE AND HIGHER WEIGHT THAN CURRENT ONE,
// ON IT'S RIGHT
// SO, WE CAN CONSTRUCT LIS[i], LSD[i], in the REVERSE ARRAY OF TRAINS, AND GET THE MAXIMUM
//POSSIBLE NUMBER BY: max(LIS[i]+LDS[i]-1) \FORall(i belongs to 0...n-1)
