...
bool cmpr(pair<SEMVAR,string>a,pair<SEMVAR,string>b)
{
	if(a.fi.a==b.fi.a && a.fi.b==b.fi.b && a.fi.c==b.fi.c){
		if(a.fi.bb==b.fi.bb)
			return a.se<b.se;
		return a.fi.bb<b.fi.bb;
	}
	if(a.fi.a!=b.fi.a)
		return a.fi.a<b.fi.a;
	if(a.fi.b!=b.fi.b)
		return a.fi.b<b.fi.b;
	if(a.fi.c!=b.fi.c)
...
//    freopen("output.txt", "w", stdout);
	...
	vector<pair<SEMVAR,string> >cont;
	vector<string>toks;
	cont.clear();

	int a,b,c;
	string sem,title,tmp;
	...
	while(getline(cin,tmp))
	{
		...
		SEMVAR newS = {stoi(toks[0]),stoi(toks[1]),stoi(toks[2]),sem};

		cont.push_back(make_pair(newS,title));
	}

	sort(cont.begin(),cont.end(),cmpr);
