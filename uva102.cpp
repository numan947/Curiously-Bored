...
the following lines in main function.*/
	...
	while(cin>>a.br>>a.gr>>a.cl>>b.br>>b.gr>>b.cl>>c.br>>c.gr>>c.cl){
		int mv = INF;
		char ch[] = {'B','C','G'};
		char ansA,ansB,ansC;
		//char chA,chB,chC;
		...
		do{
			int tmp = 0;
			if(ch[0]=='B')tmp+=b.br+c.br;
			else if(ch[0]=='C')tmp+=b.cl+c.cl;
			else if(ch[0]=='G')tmp+=b.gr+c.gr;
			
			if(ch[1]=='B')tmp+=a.br+c.br;
			else if(ch[1]=='C')tmp+=a.cl+c.cl;
			else if(ch[1]=='G')tmp+=a.gr+c.gr;
			
			if(ch[2]=='B')tmp+=b.br+a.br;
			else if(ch[2]=='C')tmp+=b.cl+a.cl;
			else if(ch[2]=='G')tmp+=b.gr+a.gr;
