...
the following lines in main function.*/
	...
	ll t0 = (((x)%1000000007)+1000000007)%1000000007;
	ll t1 = (((y)%1000000007)+1000000007)%1000000007;
	ll t2 = (((y-x)%1000000007)+1000000007)%1000000007;
	ll t3 = (((-t0)%1000000007)+1000000007)%1000000007;
	ll t4 = (((-t1)%1000000007)+1000000007)%1000000007;
	ll t5 = (((-t2)%1000000007)+1000000007)%1000000007;
	n--;
/* 
	cout<<t0<<endl;
	cout<<t1<<endl;
