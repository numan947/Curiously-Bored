...
public:
	...
	void unionSet(int i, int j)
	{
		if(!isSameSet(i,j)){
			...
			//parentList.erase(remove(parentList.begin(), parentList.end(),ip),parentList.end());
			//parentList.erase(remove(parentList.begin(), parentList.end(),jp),parentList.end());
