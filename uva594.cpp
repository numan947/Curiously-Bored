...
/*The standard C++ I/O functions (cin/cout) flush the buffer
 facon every next I/O call which unncecessarily increase I/O time.
...
//    freopen("output.txt", "w", stdout);
	...
	while(cin>>input){
		unsigned int mask0=0b00000000000000000000000011111111;
		unsigned int mask1=0b00000000000000001111111100000000;
		unsigned int mask2=0b00000000111111110000000000000000;
		unsigned int mask3=0b11111111000000000000000000000000;
		...
		cout<<input<<" converts to "<<ans<<endl;
