...
//    freopen("output.txt", "w", stdout);
	...
	sort(v.begin(),v.end(),[](IDENTITY A, IDENTITY B){
		return A.ln<B.ln;
	});
	...
	for(int i=0;i<v.size();i++){
		printf("----------------------------------------\n");
		IDENTITY x = v[i];
		cout<<x.title<<" "<<x.fn<<" "<<x.ln<<endl;
		cout<<x.ha<<endl;
		cout<<"Department: "<<x.dept<<endl;
		cout<<"Home Phone: "<<x.hp<<endl;
		cout<<"Work Phone: "<<x.wp<<endl;
		cout<<"Campus Box: "<<x.cb<<endl;
	}
