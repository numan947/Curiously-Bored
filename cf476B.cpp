...
the following lines in main function.*/
	...
	// cout<<n1<<" "<<n2<<endl;
	if(p1==p2 && n1==n2){
		cout<<prec(12)<<1.0<<endl;
	}
	//case 2: RECEIVED SOME SYMBOL MORE
	else if(n2>n1 || p2>p1){
		cout<<prec(12)<<0.0<<endl;
	}
	//case 3: RECEIVED SOME SYMBOL LESS
	else{
		int needP = p1 - p2;
		int needN = n1 - n2;
		...
		int totalOptions = (1<<u2);

		int r = needP;

		if(needP>needN)
			r = needN;
		// cout<<needP<<" "<<needN<<endl;
		// cout<<totalOptions<<endl;
		// cout<<u2<<endl;
		int totalChoices = (fact(u2))/(fact(r)*fact(u2-r));

		
		cout<<prec(12)<<1.0*totalChoices/totalOptions<<endl;
