...
typedef struct FFFFF{
	ll numerator;
	ll denominator;
}fractNum;


fractNum add(fractNum a, fractNum b){
	return {a.numerator+b.numerator,a.denominator+b.denominator};
}

void print(fractNum a)
{
...
the following lines in main function.*/
	...
	while(tc--){
		...
		for(int i=0;i<input.size();i++){
			//print(left);print(mid);print(right);cout<<endl;
		...
		cout<<mid.numerator<<"/"<<mid.denominator<<endl;
